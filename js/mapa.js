(function () {
  ...
  const BEACON_ICON = `
    <svg class="beacon-icon" viewBox="0 0 20 14" shape-rendering="crispEdges">
      <rect x="0" y="0" width="20" height="4" fill="#9C6C1F"/>
      ...
      <rect x="3" y="6.8" width="4" height="3" fill="#4E8FC4" stroke="#0C0910" stroke-width="0.4"/>
      <rect x="13" y="6.8" width="4" height="3" fill="#4E8FC4" stroke="#0C0910" stroke-width="0.4"/>
